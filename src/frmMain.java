...
/**
 * ********************************************************************************
 * @author Jairo Franco Description: This program will play all the teams from each conference, Each
 * of the teams will play each other team in the same region 2 times, once as the home team and once
 * as the visitor ******************************************************************************
 */
public class frmMain extends javax.swing.JFrame {

//creating variables of the class so can be visible and accessed everywhere
    Random oRand = new Random();

    int iHomeScore;
    int iVisitScore;

    //these play method will play a game each time is called
    public void playGame() {

        do {
            iHomeScore = oRand.nextInt(101);
            iVisitScore = oRand.nextInt(101);
        } while (iHomeScore == iVisitScore);

    }

    //this method will give 5 additional points to the home team
    ...
    public void Reset() {
        ...
        /**
         * *************************************
         * Clearing the winners of conferences* **************************************
         */
        ...
        /**
         * *************************************
         * Clearing the remaing of conferences* **************************************
         */
    ...
    //this method will give 5 additional points to the visit team
    ...
    public frmMain() {
        ...
        lblNorthEastWinner.setVisible(false);
        lblSouthWestWinner.setVisible(false);
        lblChampion.setVisible(false);
    }
    ...
    private void btnPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlayActionPerformed
        ...
        lblNorthEastWinner.setVisible(true);
        lblSouthWestWinner.setVisible(true);
        lblChampion.setVisible(true);

        //Creating arrays to store the teams
        ...
        //variables of playbutton
        int iCount;
        int iCount2;

        //creating Soccer objects
        Soccer oSoccer;

        //loading each array with team objects North
        for (iCount = 0; iCount < lboxNorth.getModel().getSize(); iCount++) {
            alNorth.add(new Soccer(lboxNorth.getModel().getElementAt(iCount).toString()));

            alNorth.get(iCount).setRegion("North");

        }

        //loading each array with team objects South
        for (iCount = 0; iCount < lboxSouth.getModel().getSize(); iCount++) {
            alSouth.add(new Soccer(lboxSouth.getModel().getElementAt(iCount).toString()));

            alNorth.get(iCount).setRegion("South");
        }

        //loading each array with team objects East
        for (iCount = 0; iCount < lboxEast.getModel().getSize(); iCount++) {
            alEast.add(new Soccer(lboxEast.getModel().getElementAt(iCount).toString()));

            alNorth.get(iCount).setRegion("East");

        }

        //loading each array with team objects West
        for (iCount = 0; iCount < lboxWest.getModel().getSize(); iCount++) {
            alWest.add(new Soccer(lboxWest.getModel().getElementAt(iCount).toString()));

            alNorth.get(iCount).setRegion("West");

        }

        /**
         * **********************************************************************************
         * Play Games in the North conference each playing 2 times
         * *********************************************************************************
         */
        for (iCount = 0; iCount < alNorth.size() - 1; iCount++) {

            for (iCount2 = iCount + 1; iCount2 < alNorth.size(); iCount2++) {

                //playing the first game  with home team advantage
                playHome();

                //incrementing the wins and losses based on the game result
                if (this.iHomeScore > this.iVisitScore) {
                    alNorth.get(iCount).Wins++;
                    alNorth.get(iCount2).Losses++;

                } else {
                    alNorth.get(iCount2).Wins++;
                    alNorth.get(iCount).Losses++;
                }

                this.iHomeScore = 0;
                this.iVisitScore = 0;
                //playing the second game with visit team advantagem
                playVisit();
        ...
        /**
         * **********************************************************************************
         * Play Games in the South conference each playing 2 times
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alSouth.size() - 1; iCount++) {

            for (iCount2 = iCount + 1; iCount2 < alSouth.size(); iCount2++) {
                ...
                //incrementing the wins and losses based on the game result
                if (this.iHomeScore > this.iVisitScore) {
                    alSouth.get(iCount).Wins++;
                    alSouth.get(iCount2).Losses++;

                } else {
                    alSouth.get(iCount2).Wins++;
                    alSouth.get(iCount).Losses++;
                }
        ...
        /**
         * **********************************************************************************
         * Play Games in the East conference each playing 2 times
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alEast.size() - 1; iCount++) {

            for (iCount2 = iCount + 1; iCount2 < alEast.size(); iCount2++) {
                ...
                //incrementing the wins and losses based on the game result
                if (this.iHomeScore > this.iVisitScore) {
                    alEast.get(iCount).Wins++;
                    alEast.get(iCount2).Losses++;

                } else {
                    alEast.get(iCount2).Wins++;
                    alEast.get(iCount).Losses++;
                }
        ...
        /**
         * **********************************************************************************
         * Play Games in the West conference each playing 2 times
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alWest.size() - 1; iCount++) {

            for (iCount2 = iCount + 1; iCount2 < alWest.size(); iCount2++) {
                ...
                //incrementing the wins and losses based on the game result
                if (this.iHomeScore > this.iVisitScore) {
                    alWest.get(iCount).Wins++;
                    alWest.get(iCount2).Losses++;

                } else {
                    alWest.get(iCount2).Wins++;
                    alWest.get(iCount).Losses++;
                }
        ...
        /**
         * **********************************************************************************
         * Play Games North conference vs South Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alNorth.size(); iCount++) {

            for (iCount2 = 0; iCount2 < alSouth.size(); iCount2++) {

                this.iHomeScore = 0;
                this.iVisitScore = 0;
                //playing a game with no team advantage
                playGame();
        ...
        /**
         * **********************************************************************************
         * Play Games North conference vs East Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alNorth.size(); iCount++) {

            for (iCount2 = 0; iCount2 < alEast.size(); iCount2++) {
        ...
        /**
         * **********************************************************************************
         * Play Games North conference vs West Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alNorth.size(); iCount++) {

            for (iCount2 = 0; iCount2 < alWest.size(); iCount2++) {
        ...
        /**
         * **********************************************************************************
         * Play Games South conference vs West Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alSouth.size(); iCount++) {
        ...
        /**
         * **********************************************************************************
         * Play Games South conference vs East Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alSouth.size(); iCount++) {
        ...
        /**
         * **********************************************************************************
         * Play Games West conference vs East Conference each playing 1 time
         * ********************************************************************************
         */
        for (iCount = 0; iCount < alWest.size(); iCount++) {
        ...
        /**
         * ***************************************
         * Sorting all the arrays based on the wins* ***************************************
         */
        Collections.sort(alNorth, Soccer.alSort);
        Collections.sort(alSouth, Soccer.alSort);
        Collections.sort(alEast, Soccer.alSort);
        Collections.sort(alWest, Soccer.alSort);

        /**
         * ********************************************************************************
         * Displaying by order of wins in the following order (Name, Wins, Losses *
         * ********************************************************************************
         */
        ...
        /**
         * ****************************************************
         * Computing and Displaying the GB of conferences*
         * ***************************************************
         */
        oSoccer = new Soccer();
        
        lblNorthTeam1GB.setText("--");
        lblNorthTeam2GB.setText(String.valueOf(oSoccer.calcGB(alNorth.get(0).getWins(), alNorth.get(1).getWins())));
        lblNorthTeam3GB.setText(String.valueOf(oSoccer.calcGB(alNorth.get(0).getWins(), alNorth.get(2).getWins())));
        lblNorthTeam4GB.setText(String.valueOf(oSoccer.calcGB(alNorth.get(0).getWins(), alNorth.get(3).getWins())));
        lblNorthTeam5GB.setText(String.valueOf(oSoccer.calcGB(alNorth.get(0).getWins(), alNorth.get(4).getWins())));
        lblNorthTeam6GB.setText(String.valueOf(oSoccer.calcGB(alNorth.get(0).getWins(), alNorth.get(5).getWins())));

        lblSouthTeam1GB.setText("--");
        lblSouthTeam2GB.setText(String.valueOf(oSoccer.calcGB(alSouth.get(0).getWins(), alSouth.get(1).getWins())));
        lblSouthTeam3GB.setText(String.valueOf(oSoccer.calcGB(alSouth.get(0).getWins(), alSouth.get(2).getWins())));
        lblSouthTeam4GB.setText(String.valueOf(oSoccer.calcGB(alSouth.get(0).getWins(), alSouth.get(3).getWins())));
        lblSouthTeam5GB.setText(String.valueOf(oSoccer.calcGB(alSouth.get(0).getWins(), alSouth.get(4).getWins())));
        lblSouthTeam6GB.setText(String.valueOf(oSoccer.calcGB(alSouth.get(0).getWins(), alSouth.get(5).getWins())));

        lblEastTeam1GB.setText("--");
        lblEastTeam2GB.setText(String.valueOf(oSoccer.calcGB(alEast.get(0).getWins(), alEast.get(1).getWins())));
        lblEastTeam3GB.setText(String.valueOf(oSoccer.calcGB(alEast.get(0).getWins(), alEast.get(2).getWins())));
        lblEastTeam4GB.setText(String.valueOf(oSoccer.calcGB(alEast.get(0).getWins(), alEast.get(3).getWins())));
        lblEastTeam5GB.setText(String.valueOf(oSoccer.calcGB(alEast.get(0).getWins(), alEast.get(4).getWins())));
        lblEastTeam6GB.setText(String.valueOf(oSoccer.calcGB(alEast.get(0).getWins(), alEast.get(5).getWins())));

        
        lblWestTeam1GB.setText("--");
        lblWestTeam2GB.setText(String.valueOf(oSoccer.calcGB(alWest.get(0).getWins(), alWest.get(1).getWins())));
        lblWestTeam3GB.setText(String.valueOf(oSoccer.calcGB(alWest.get(0).getWins(), alWest.get(2).getWins())));
        lblWestTeam4GB.setText(String.valueOf(oSoccer.calcGB(alWest.get(0).getWins(), alWest.get(3).getWins())));
        lblWestTeam5GB.setText(String.valueOf(oSoccer.calcGB(alWest.get(0).getWins(), alWest.get(4).getWins())));
        lblWestTeam6GB.setText(String.valueOf(oSoccer.calcGB(alWest.get(0).getWins(), alWest.get(5).getWins())));

        /**
         * *************************************
         * Displaying the winners of conferences* **************************************
         */
        ...
        /**
         * *************************************
         * Playing Winner of North vs Winner of East* **************************************
         */
        playGame();
        ...
        /**
         * *************************************
         * Playing Winner of South vs West of East* **************************************
         */
        playGame();
